...
class AppStrings {
  ...
  String get loginWelcome    => _t('Добро пожаловать!', 'Բարի գալուստ');
  String get loginHeroTag    => _t(
      'Билеты на лучшие события Армении',
      'Տոմսեր Հայաստանի լավագույն միջոցառումների');
  String get loginStepPhone  => _t('Телефон', 'Հեռախոս');
  String get loginStepCode   => _t('Код', 'Կոդ');
  String get loginSecureNote => _t(
      'Вход защищён. Мы никогда не запрашиваем пароль.',
      'Մուտքը պաշտպանված է։ Մենք երբեք գաղտնաբառ չենք պահանջում։');
  String codeSentTo(String phone) => _t(
      'Код отправлен на $phone',
      'Կոդն ուղարկվել է $phone համարին');
  ...
  String get rescheduleBannerBodyNoDate => _t(
      'Организатор переносит мероприятие. Подтвердите участие или запрос��те возврат.',
